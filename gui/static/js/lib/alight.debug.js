...
(function() {
  ...
  bindComment = function(scope, element) {
    var args, d, dirName, directive, e, env, err, i, list, result, text, value;
  ...
  process = (function() {
    ...
    return function(scope, element, config) {
      var args, attrName, attr_value, attrs, d, directive, e, env, err, fn, list, node, result, skip_attr, skip_children, value, _i, _j, _len, _len1, _ref;
      config = config || {};
      skip_children = false;
...
(function() {
  ...
  alight.utilits.parsExpression = function(line, cfg) {
    var d, exp, i, index, input, n, newName, pars, prev, result, variable, variable_names, variables, _i;
    cfg = cfg || {};
    input = cfg.input || [];
    index = 0;
    result = [];
    ...
    pars = function(lvl, stop, convert, is_string) {
      ...
      check_variabe = function() {
        ...
        return variable_names.push(variable);
      };
    ...
    if (variables.length) {
      ...
      for (i = _i = variables.length - 1; _i >= 0; i = _i += -1) {
        ...
        d = variable.split('.');
        if (d.length > 1) {
          newName = '(((((((((((('.slice(0, d.length - 1) + 'this.' + d.join(' || {}).');
        } else {
          newName = 'this.' + variable;
        }
