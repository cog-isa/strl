define(["/static/libs/aplib.js", "/static/libs/js/lib/finchjs/finch.js",],
		function( _aplib, _finch){

        // global dpi для расчетов размера пикселей на дюйм в мониторе - разрешение
  /*      dpi = {
            v: 0,
...
*/
	...
	ap.jsdesc['agent'] = {
		fields:{
			...
			isVisible: true, //задать видимость
