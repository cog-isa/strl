...
ChangeDetector.prototype.digest = function() {
  var callback, duration, e, j, len, mainLoop, onScanOnce, result, root, totalChanges;
  root = this.root;
  mainLoop = 10;
  totalChanges = 0;
  try {
...
ChangeDetector.prototype.scan = function(cfg) {
  var callback, cb, finishScanOnce, j, k, l, len, len1, len2, ref, ref1, result, root, start;
  root = this.root;
  cfg = cfg || {};
  if (f$.isFunction(cfg)) {
    cfg = {
...
(function() {
  ...
  return alight.utils.parsExpression = function(expression, option) {
    var build, data, inputKeywords, pars, ret, splitVariable, toKey, uniq;
    option = option || {};
    inputKeywords = option.input || [];
    uniq = 1;
    ...
    build = function(part) {
      var c, childName, d, j, k, key, l, len, len1, len2, len3, m, n, name, ref, ref1, ref2, ref3, result, v;
      result = '';
      ref = part.result;
      for (j = 0, len = ref.length; j < len; j++) {
        d = ref[j];
